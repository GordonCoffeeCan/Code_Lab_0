...
function preload() {
    ...
    game.stage.backgroundColor = 0x589DE0;
...
function create() {
    ...
    smiley = game.add.sprite(game.width*0.5, game.height - 75, 'playerSprite');
    ...
    smiley.body.gravity.y = 300; //how fast the player should accelerate with gravity
    ...
    hat = game.add.sprite(smiley.x,smiley.y-40,'hatSprite');
    ...
    ground.x = game.width*0.5; //start in the middle of the screen
    ground.y = game.height - 25; //start 25px above the bottom of the screen
